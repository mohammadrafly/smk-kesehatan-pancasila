...
@section('content')
      <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg" style="background-image: url('assets_backend/img/curved-images/curved14.jpg');">
        ...
        <div class="row mt-lg-n10 mt-md-n11 mt-n10">
          <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
            <div class="card z-index-0">
              ...
              <div class="card-body">
                <form role="form text-left" action="{{ route('register.custom') }}" method="POST">
                  @csrf
                  <div class="mb-3">
                  ...
                  <div class="text-center">
                    <button type="sbumit" class="btn bg-gradient-dark w-100 my-4 mb-2">Sign up</button>
                  </div>
