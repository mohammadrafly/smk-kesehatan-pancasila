...
<head>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="{!! asset('assets_backend/img/apple-icon.png') !!}">
  <link rel="icon" type="image/png" href="{!! asset('assets_backend/img/favicon.png') !!}">
  <title>
    BackEnd SMK 4 Kesehatan Pancasila
  </title>

  <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700" rel="stylesheet" />
  <!-- Nucleo Icons -->
  <link href="{!! asset('assets_backend/css/nucleo-icons.css') !!}" rel="stylesheet" />
  <link href="{!! asset('assets_backend/css/nucleo-svg.css') !!}" rel="stylesheet" />
  <!-- Font Awesome Icons -->
  <script src="https://kit.fontawesome.com/42d5adcbca.js') !!}" crossorigin="anonymous"></script>
  <link href="{!! asset('assets_backend/css/nucleo-svg.css') !!}" rel="stylesheet" />
  <!-- CSS Files -->
  <link id="pagestyle" href="{!! asset('assets_backend/css/soft-ui-dashboard.css?v=1.0.5') !!}" rel="stylesheet" />
</head>
...
<body class="g-sidenav-show  bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html " target="_blank">
        <img src="{!! asset('assets_backend/img/logo-ct.png') !!}" class="navbar-brand-img h-100" alt="main_logo">
        <span class="ms-1 font-weight-bold">Backend SMK 4</span>
      </a>
    </div>
        ...
        <footer class="footer pt-3  ">
            ...
            <div class="row align-items-center justify-content-lg-between">
                ...
                <div class="copyright text-center text-sm text-muted text-lg-start">
                    ...
                    made with ❤</i> by
                    <a href="" class="font-weight-bold" target="_blank">SMK 4 Kesehatan Pancasila</a>
                </div>
                </div>
            </div>
            </div>
  ...
  <script src="{!! asset('assets_backend/js/plugins/perfect-scrollbar.min.js') !!}"></script>
  <script src="{!! asset('assets_backend/js/plugins/smooth-scrollbar.min.js') !!}"></script>
  <script src="{!! asset('assets_backend/js/plugins/chartjs.min.js') !!}"></script>
  <script>
  ...
  <script src="{!! asset('assets_backend/js/soft-ui-dashboard.min.js?v=1.0.5') !!}"></script>
</body>
